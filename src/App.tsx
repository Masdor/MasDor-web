...
// ─── Components ───
function Reveal({ children, delay = 0, style: extraStyle = {} }: { children: ReactNode; delay?: number; style?: CSSProperties }) {
...
function HoverCard({ children, style, accentColor = GOLD, glowOnHover = false }: { children: ReactNode; style?: CSSProperties; accentColor?: string; glowOnHover?: boolean }) {
...
// ─── Shared Styles ───
const btnStyle: CSSProperties = { display: "inline-block", padding: "14px 32px", fontWeight: 600, fontSize: 14, borderRadius: 11, textDecoration: "none", fontFamily: SANS, letterSpacing: "0.01em", transition: "all 0.3s ease" };
const tagBadgeStyle: CSSProperties = { display: "inline-block", fontFamily: MONO, fontSize: 11, letterSpacing: 3, color: GOLD, textTransform: "uppercase", background: `${GOLD}0a`, padding: "6px 16px", borderRadius: 6, border: `1px solid ${GOLD}18` };
const sectionTitleStyle: CSSProperties = { fontSize: "clamp(1.8rem, 3.5vw, 2.6rem)", fontWeight: 700, letterSpacing: "-0.015em", lineHeight: 1.15 };
const subtitleStyle: CSSProperties = { fontSize: "clamp(1rem, 1.4vw, 1.1rem)", color: TEXT_SECONDARY, lineHeight: 1.7 };
const labelStyle: CSSProperties = { display: "block", fontSize: 12, fontWeight: 500, color: TEXT_SECONDARY, marginBottom: 8, fontFamily: MONO };
const inputStyle: CSSProperties = { width: "100%", padding: "13px 16px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 10, color: TEXT_PRIMARY, fontSize: 15, fontFamily: SANS, transition: "border-color 0.25s ease, box-shadow 0.25s ease", boxSizing: "border-box" };
const infoCardStyle: CSSProperties = { padding: "24px 22px", background: CARD_BG, borderRadius: 14, border: `1px solid ${CARD_BORDER}` };
const infoTitleStyle: CSSProperties = { fontSize: 12, fontWeight: 600, color: GOLD, fontFamily: MONO, letterSpacing: 1.5, textTransform: "uppercase", marginBottom: 16 };
